...
TEST_MODE = "GRAPH" # "GRAPH" or "LEGACY"
...
if __name__ == "__main__":
    os.makedirs("evaluation_log", exist_ok=True)
    log_filename = os.path.join("evaluation_log", f"evaluation_log_{datetime.datetime.now().strftime('%Y%m%d_%H%M')}.txt")
